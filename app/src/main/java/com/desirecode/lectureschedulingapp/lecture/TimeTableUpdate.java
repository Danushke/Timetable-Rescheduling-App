...
import com.desirecode.lectureschedulingapp.notification.Notification;
...
public class TimeTableUpdate extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    String setDate,setTimeFrom,setTimeTo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_notify=findViewById(R.id.buttonNotifyCeck);
        ...
        btn_notify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //displayNotification(placeParam,placeParam);
            }
        });
