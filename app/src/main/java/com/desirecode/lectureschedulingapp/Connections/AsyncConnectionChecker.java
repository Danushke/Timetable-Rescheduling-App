...
public class AsyncConnectionChecker extends AsyncTask< Void, Void, Boolean > {
private OnConnectionCallback onConnectionCallback;
private Context context;

public AsyncConnectionChecker(Context con, OnConnectionCallback onConnectionCallback) {
        super();
