...
public class FragmentTimeTableAdapter extends RecyclerView.Adapter<FragmentTimeTableAdapter.TimeTableViewHolder> {

    private Context mCtx; // to create layout inflater
    private List<TimeTableGetter> timeTableList;

    public FragmentTimeTableAdapter(Context mCtx, List<TimeTableGetter> timeTableList) {
        this.mCtx = mCtx;
